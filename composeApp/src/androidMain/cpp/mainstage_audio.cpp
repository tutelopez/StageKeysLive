...
// 1 = CONFIG A (Baseline): 8 logical channels, 64 global polyphony, 32 physical pool with shadow channels
// 2 = CONFIG B (12 channels): 12 logical channels, 96 global polyphony, 32 physical pool with shadow channels
// 3 = CONFIG C (16 channels): 16 logical channels, 128 global polyphony, 32 physical pool with shadow channels
...
#define PREVIEW_CHANNEL (NUM_PHYSICAL_CHANNELS - 1)
    ...
    #define BENCHMARK_MODE_NAME "CONFIG_A_8CH_64POLY"
#elif BENCHMARK_MODE == 2
    #define NUM_LOGICAL_CHANNELS 12
    #define GLOBAL_POLYPHONY 96
    #define SHADOW_SYSTEM_ENABLED 1
    #define BENCHMARK_MODE_NAME "CONFIG_B_12CH_96POLY"
#elif BENCHMARK_MODE == 3
    #define NUM_LOGICAL_CHANNELS 16
    #define GLOBAL_POLYPHONY 128
    #define SHADOW_SYSTEM_ENABLED 1
    #define BENCHMARK_MODE_NAME "CONFIG_C_16CH_128POLY"
#endif
...
public:
    ...
    const char* getBenchmarkModeName() const {
        return BENCHMARK_MODE_NAME;
    }
};
...
JNIEXPORT jstring JNICALL
Java_com_midi_mainstage_PlatformAudioSynth_nativeGetBenchmarkModeName(JNIEnv *env, jobject thiz) {
    const char* name = (gEngine != nullptr) ? gEngine->getBenchmarkModeName() : BENCHMARK_MODE_NAME;
